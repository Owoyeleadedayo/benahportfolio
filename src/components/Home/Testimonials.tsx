...
const Testimonials = () => {
 ...
 useEffect(() => {
  ...
  return (
    <section className="py-20 px-6 md:px-12 lg:px-24 bg-accent text-white overflow-hidden relative">
      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center gap-6 md:gap-12 relative z-10">
        {/* Section Header */}
        <div className="flex flex-col items-center text-center gap-2 md:gap-4">
          ...
          <h2 className="text-xl md:text-4xl font-semibold text-gray-800 font-sora tracking-tight">
            Client Testimonials
          </h2>
          <p className="text-gray-400 max-w-lg text-base md:text-base">
            What industry leaders and clients say about our construction
            services.
          </p>
        </div>

        {/* Testimonial Slider Box */}
        <div className="w-full relative min-h-[350px] md:min-h-[280px] bg-white/40 border border-white/10 rounded-3xl p-8 md:p-12 flex flex-col justify-center items-center text-center shadow-xl backdrop-blur-md">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* Review Text */}
              <p className="text-lg md:text-xl text-gray-500 leading-relaxed font-light italic max-w-2xl">
                &quot;{reviews[active].text}&quot;
              </p>
            ...
            {reviews.map((_, idx) => (
              <button
                ...
                className={`h-2.5 rounded-full transition-all duration-300 ${
                  active === idx ? "w-8 bg-[#f78f36]" : "w-2.5 bg-gray-900/10"
                }`}
